...
public class QuoteEndpoint implements CrudService<Quote, Long> {
    ...
    // generate a quoteBook method which responds to the UI and retrieves a quote by book name; use the QuoteService class to retrieve the book by name, as a String
